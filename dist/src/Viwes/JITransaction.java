...
public class JITransaction extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        rdncheque.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rdnchequeActionPerformed(evt);
            }
        });

        rdvirement.setText("Virmement ");
        rdvirement.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rdvirementActionPerformed(evt);
            }
        });
    ...
    private void btnAjouterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAjouterActionPerformed
        try {
          ...
          //  Commande cmd=(Commande) cbxcommande.getSelectedItem();
    ...
    private void rdnchequeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rdnchequeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_rdnchequeActionPerformed

    private void rdvirementActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rdvirementActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_rdvirementActionPerformed
    ...
    private void cbxclientItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbxclientItemStateChanged
        ...
        /*      try {
            Client c=(Client) cbxclient.getSelectedItem();
            Connection con=Connect.seconnenter();
            PreparedStatement ps=con.prepareStatement("select *from commandeclient where id_clt=?");
            ps.setInt(1, c.getId_clt());
            ResultSet rs=ps.executeQuery();
            cbxcommande.removeAllItems();
            while(rs.next()){
                cbxcommande.addItem(new Commande(rs.getInt(1),rs.getDate(2),rs.getInt(3)));
            }
        } catch (Exception ex) {
            Logger.getLogger(JITransaction.class.getName()).log(Level.SEVERE, null, ex);
        }*/
